...
import { useCreateUploadMutation, useCreateSupplierMutation, useForceDeleteUploadsMutation } from '@/state/api';
...
const Page = () => {
  ...
  return (
    <div>
      <h2 className='text-2xl font-semibold mb-4'>Create Supplier</h2>

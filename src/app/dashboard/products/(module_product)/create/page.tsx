...
const Page = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const response = await createProduct(dataToSend).unwrap();
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          ...
          <div>
            ...
            <input
              type='number'
              name='costPrice'
              value={formik.values.costPrice as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <input
              type='number'
              name='discount'
              value={formik.values.discount as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <input
              type='number'
              name='stock'
              value={formik.values.stock as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <input
              type='number'
              name='reorderLevel'
              value={formik.values.reorderLevel as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <select
              name='categoryId'
              value={formik.values.categoryId as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
        ...
        <div className='mt-6 grid gridcols-1 md:grid-cols-3 gap-6'>
          ...
          <div>
            ...
            <input
              type='number'
              name='width'
              value={formik.values.width as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <input
              type='number'
              name='height'
              value={formik.values.height as number}
              onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              className={`bg-transparent mt-1 p-2 w-full border-2 border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${

...
import { useCreateUploadMutation, useCreateCustomerMutation, useForceDeleteUploadsMutation } from '@/state/api';
...
const Page = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const response = await createCustomer(dataToSend).unwrap();

...
export const api = createApi({
	...
	endpoints: (build) => ({
		...
		getUniqueProductHistories: build.query<ResponseProductHistories, void>({
			query: () => '/products/histories/unique',
			providesTags: ['ProductHistories'],
		}),

		getProductHistoriesByProductId: build.query<ResponseProductHistories, { productId: string }>({
			query: ({ productId }) => `/products/${productId}/histories`,
			providesTags: ['ProductHistories'],
		}),
...
export const {
	...
	useGetProductHistoriesByProductIdQuery,
